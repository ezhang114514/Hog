...
def boar_brawl(player_score, opponent_score):
    ...
    round_score=a-b if a>b else b-a
    round_score*=3
    if(round_score==0):
        round_score=1
    return round_score
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_roll_(player_score,opponent_score):
        return n
    return always_roll_
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    i=1
    averaged_tool=make_averaged(roll_dice,samples_count)
    maxx=0
    while(i<=10):
        y2=averaged_tool(i,dice)
        if(y2>maxx):
            maxx=y2
            maxxvalue=i
        i+=1
